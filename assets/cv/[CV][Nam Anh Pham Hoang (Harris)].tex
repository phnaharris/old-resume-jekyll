...
\section{WORKING EXPERIENCE}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\normalsize{Smart contract interaction using many different technologies.}}
      \resumeItemListEnd
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{\normalsize{Languages:}}{ \normalsize{C\#, C/C++, XAML, T-SQL, Python, Shell, HTML, Arduino, Java, Dart, Golang, Solidity...}} \\
     \textbf{\normalsize{Developer Tools:}}{ \normalsize{VS Code, Visual Studio, SQL Server Management Studio, Remix, Android Studio, Jupyter Notebook, Postman, ngrok.io...}} \\
     \textbf{\normalsize{Technologies/Frameworks:}}{\normalsize{ Xamarin.Forms with MVVM pattern, ASP.NET MVC with Entity Framework, WPF, Selenium, Linux, Git, Flutter, Distributed System/Consensus...}} \\
    }}
 \end{itemize}
 \vspace{-15pt}
